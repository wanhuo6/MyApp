...
//            TextPaint tp = mToolbarTitle.getPaint();
    ...
    public static class TitleConfig {
        ...
        public TitleConfig setRightObject(View[] views) {
            rightViews = views;
            return this;
        }
    ...
    public void setRightMenu(View[] views) {
        ...
        for (int i = 0; i < views.length; i++) {
            ...
            if (view.getPaddingLeft() == 0 && view.getPaddingBottom() == 0 && view.getPaddingRight() == 0 && view.getPaddingTop() == 0) {
                view.setPadding(CommonUtils.dpTopx(getContext(), 10), CommonUtils.dpTopx(getContext(), 5), CommonUtils.dpTopx(getContext(), 10), CommonUtils.dpTopx(getContext(), 5));
            }
